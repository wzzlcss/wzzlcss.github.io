...
<p style="text-align:justify;">
Here is a benchmark [Sript] with artificial data of size 100 to illustrate C-SAGA and mini-batch SAGA's features, where the batch size is fixed to 10 and $\lambda = 0.01$. The C-SAGA is more efficient at evaluating each epoch.
</p>
